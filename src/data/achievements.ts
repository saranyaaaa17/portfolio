...
export const certifications: Certification[] = [
  { name: "Oracle OCI 2025 AI Foundations Associate", issuer: "Oracle University", icon: Trophy, link: "https://catalog-education.oracle.com/ords/certview/sharebadge?id=EB06C9DDF1443FFB918689F027331D0C1327329824115A8016EDDF007DE7A856" },
  { name: "Gen AI & Data Science", issuer: "GeeksforGeeks", icon: Award, link: "https://www.geeksforgeeks.org/certificate/c332f5e01804f1b075332f798816c160" },
  { name: "Machine Learning (Internship)", issuer: "Internshala", icon: Award, link: "https://drive.google.com/file/d/10Fs8lqmXORQHnF9WMHGgYtVrzynP2lgN/view?usp=drive_link" },
