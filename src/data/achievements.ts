...
export const certifications: Certification[] = [
  { name: "Oracle Cloud Infrastructure 2025 AI Foundations Associate", issuer: "Oracle University", icon: Trophy, link: "https://catalog-education.oracle.com/ords/certview/sharebadge?id=EB06C9DDF1443FFB918689F027331D0C1327329824115A8016EDDF007DE7A856" },
  ...
  { name: "Generative AI", issuer: "GeeksforGeeks", icon: Trophy, link: "https://www.geeksforgeeks.org/certificate/b555eac0c11dd17132ba15eae6d5a1eb" },
  ...
  { name: "Responsive Web Design", issuer: "FreeCodeCamp", icon: Award, link: "https://www.freecodecamp.org/certification/saranyaaaa17/responsive-web-design" },
...
export const highlights: Highlight[] = [
  {
    ...
    description: "Awarded for demonstrating leadership and discipline in the National Cadet Corps",
    icon: Trophy
  },
  {
  ...
  },
  {
    ...
    description: "Attended workshop organised by The Skill Shop",
    icon: Award
  }
];
